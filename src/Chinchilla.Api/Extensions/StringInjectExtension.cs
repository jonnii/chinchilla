...
{
    /// <summary>
    /// Set of extenstion methods that replases keys in a string with the values.
    /// Source code from http://mo.notono.us/2008/07/c-stringinject-format-strings-by-key.html.
    /// </summary>
    public static class StringInjectExtension
    {
        ...
        public static string Inject(this string formatString, Dictionary<string, string> attributes)
        {
