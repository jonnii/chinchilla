...
task Test -depends Clean,CopyTools,Compile { 
  # run specs
  ..\src\packages\Machine.Specifications.0.5.9\tools\mspec-clr4.exe .\..\targets\specifications\chinchilla.specifications.dll
  ..\src\packages\Machine.Specifications.0.5.9\tools\mspec-clr4.exe .\..\targets\specifications\chinchilla.api.specifications.dll
